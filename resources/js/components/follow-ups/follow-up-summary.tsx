...
export function FollowUpSummary({ followUps, parentType, parentId, canCreate }: { followUps: FollowUpSummaryItem[]; parentType: 'lead' | 'customer' | 'deal'; parentId: number; canCreate: boolean }) {
