...
Route::middleware('auth')->group(function () {
    ...
    Route::post('instances/{applicationInstance}/provisioning', [TenantProvisioningController::class, 'start'])->name('instances.provisioning.start');
    Route::post('instances/{applicationInstance}/provisioning/resume', [TenantProvisioningController::class, 'resume'])->name('instances.provisioning.resume');
    Route::post('instances/{applicationInstance}/provisioning/retry', [TenantProvisioningController::class, 'retryStep'])->name('instances.provisioning.retry');
    Route::put('instances/{applicationInstance}/administrator', [TenantProvisioningController::class, 'administrator'])->name('instances.administrator.update');
