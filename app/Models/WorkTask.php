...
class WorkTask extends Model
{
    ...
    protected $fillable = ['customer_id', 'lead_id', 'product_id', 'application_instance_id', 'support_ticket_id', 'assigned_to_id', 'created_by_id', 'task_number', 'title', 'description', 'priority', 'status', 'due_at', 'completed_at', 'automation_key'];
