...
{
    public function authorize(): bool { return $this->user()->can('create', Payment::class); }
    public function rules(): array
    {
        return [
            'subscription_id' => ['required', 'integer', Rule::exists('subscriptions', 'id')->whereNull('deleted_at')],
            'invoice_number' => ['required', 'string', 'max:64', Rule::unique('payments', 'invoice_number')->withoutTrashed()],
